...
public class AlertView: UIView, DecoratableViewProtocol {
    ...
    private func generateButton(source: AlertButtonDataSource) -> UIButton {
        let button = AlertButton(source: source)
...
extension AlertView {
    ...
    public class Builder {
        ...
        @discardableResult
        public func addButton(dataSource: AlertButtonDataSource) -> Builder {
        ...
        public func getAlertView() -> AlertView {
            alertView = AlertView(dataSource: dataSource)
        ...
        public func show() {
            ...
            DecoratableViewDataSource.Builder(alertView: getAlertView(), alertDecorator: alertDecorator, withDefaultAnimationInstance: false)
