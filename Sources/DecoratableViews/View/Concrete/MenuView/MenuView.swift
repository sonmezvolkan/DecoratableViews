...
public class MenuView: UIView, DecoratableViewProtocol {
    ...
    private func setUp() {
        let bundle = Bundle.getPodBundle(forClassType: MenuView.self)
        bundle.loadNibNamed("MenuView", owner: self, options: nil)
...
extension MenuView: UITableViewDelegate, UITableViewDataSource {
    ...
    private func setTableView() {
        ...
        let bundle = Bundle.getPodBundle(forClassType: MenuView.self)
        tableView.register(UINib(nibName: "MenuCell", bundle: bundle), forCellReuseIdentifier: "MenuCell")
    }
