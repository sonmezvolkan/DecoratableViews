...
public class AlertButtonDataSource {
...
extension AlertButtonDataSource {
    ...
    public class Builder {
        ...
        public func build() -> AlertButtonDataSource {
            return AlertButtonDataSource(title: title,
                                            onDidTap: onDidTap,
