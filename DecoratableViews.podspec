...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "DecoratableViews", "Sources/DecoratableViews/**/*.{h,m,swift,png,xib}"
  spec.exclude_files = "Classes/Exclude"


  spec.resource_bundles = {
    "DecoratableViews" => ["Sources/DecoratableViews/**/*.{storyboard,xib,png}"]
  }
  ...
  spec.resources = "Sources/DecoratableViews/**/*.{lproj,storyboard,xib,png}"
